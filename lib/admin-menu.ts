...
export const MENU_ITEMS: MenuItemDef[] = [
    ...
    { id: "coupons",          label: "쿠폰",             href: null,                             icon: "Ticket",          parentId: null,         defaultVisibleSuper: true,  defaultVisibleGeneral: true  },
    { id: "coupons-manage",   label: "쿠폰 관리",        href: "/admin/coupons",                 icon: "TicketX",         parentId: "coupons",    defaultVisibleSuper: true,  defaultVisibleGeneral: true  },
    { id: "coupons-issuance", label: "쿠폰 발급",        href: "/admin/coupon-issuance",         icon: "Send",            parentId: "coupons",    defaultVisibleSuper: true,  defaultVisibleGeneral: true  },
