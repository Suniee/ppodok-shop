...
export default function Header() {
  ...
  return (
    <header className="bg-white sticky top-0 z-50" style={{ borderBottom: "1px solid var(--toss-border)" }}>
      <div className="max-w-5xl mx-auto px-5">
        <div className="flex items-center gap-5 h-[60px]">
          ...
          <div className="flex items-center gap-1 ml-auto">
            <button className="p-2.5 rounded-xl transition-colors hover:bg-gray-50 relative" style={{ color: "var(--toss-text-secondary)" }}>
